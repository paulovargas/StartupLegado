...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>Todos os Animais da Propriedade</h1><a target ="_blank" href="relatorioAnimais.php" id="acc-details">Imprimir relatório </a>
	</div>
	<!-- end page-heading -->
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<?php				
							...
							$sql = "SELECT * FROM animais JOIN propriedade ON animais.propriedade_id = propriedade.id JOIN rebanho on animais.rebanho_id = rebanho.id where propriedade.id = $id order by nomeRebanho asc";  //JOIN finalidade_animal ON animais.finalidade_animal_id = finalidade_animal.id
