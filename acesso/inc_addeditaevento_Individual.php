...
<div id="page-heading"><h1>Adicionar Evento Individual</h1></div>
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<form action="envia_eventoIndividual.php" method="POST">	
		...
		<?php
							...
							while($consulta = mysqli_fetch_array($result)){ 
								...
								$rebanho = $consulta['rebanho_id'];
								$propriedade_id = $consulta['propriedade_id'];
								$brinco = $consulta['numero_brincos'];
								$nome = $consulta['nome'];
								...
								echo "<td><input type='hidden' value ={$consulta['rebanho_id']} class='' name='rebanho_id' /></td>";
								echo "<td><input type='hidden' value ={$consulta['idanimal']} class='' name='animal_id' /></td>";
								
								echo "<td><input type='hidden' value = '2' class='' name='evento_grupo' /></td>";
								//echo "<td><input type='hidden' value ={$consulta['idevenR']} class='' name='idEvenR' /></td>";
								echo "<tr><th valign='center'>Brinco:</th>";
								echo "<td><input value = $brinco disabled ='disabled' type= $brinco class='inp-form' name='' /></td>";
								echo "<td></td>";
								echo "</tr>";
								echo "<td></td>";
								echo "</tr>";
								...
								echo "	<td><input value = 'data' type='date' class='inp-form' name='data_evento' /></td>";
								echo "	<td></td>";
								echo "</tr>";
								echo "<td></td>";
								echo "</tr>";
