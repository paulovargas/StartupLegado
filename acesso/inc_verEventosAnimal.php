...
<div id="content">
	...
	<div id="page-info">
			...
			echo" <div class='step-dark-left'><a href='index.php?pagina=addeditaevento_Individual&id=$id'>Adicionar novo evento</a></div>";
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<?php
							...
							$sql = "SELECT * FROM animais JOIN eventos on animais.idanimal = eventos.animal_id where idanimal = $idA";
							$result = mysqli_query($conecta, $sql);
								...
								echo "</strong></td>";
								//echo "<td><strong>{$consulta['data_evento']}</strong></td>";
								//echo "<td><strong>";
								// echo date('d/m/Y', strtotime($consulta['data_eve']));
								// "</strong></td>";
								...
								echo "<td class='options-width'><a href='index.php?pagina=addeditaeventoIndividual&id=$id' title='Editar' class='icon-1 info-tooltip'></a><a href='index.php?pagina=excluir_Evento_Individual&id=$id&&idAnimal=$aid' title='Excluir' class='icon-2 info-tooltip'></a></td>";
				...
				<?php
						...
						if($num < 1)
							echo "<strong><h2>Este animal não possui eventos!</h2></strong>";
