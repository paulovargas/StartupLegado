		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a>Cliente</a>	</th>
				...
				<?php							
							...
							$sql = "SELECT * FROM usuario INNER JOIN cliente ON usuario.cliente_id = cliente.id";
							...
							while($consulta = mysqli_fetch_array($result)) { 
								...
								echo "<td class='options-width'><a href='admin.php?pagina=addeditausu&id=$vid' title='Editar' class='icon-1 info-tooltip' type='submit''></a><a href='' title=Excluir class=icon-2 info-tooltip></a></td>";
